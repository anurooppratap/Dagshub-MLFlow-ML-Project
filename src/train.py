...
# def train(data_path, model, random_state, n_estimators, max_depth):
#     data = pd.read_csv(data_path)
#     X = data.drop(columns=["Outcome"])
#     y = data['Outcome']
...
#         # log additional metrics
#         mlflow.log_metric("accuracy",accuracy)
#         mlflow.log_param("best_n_estimators",grid_serach.best_params_['n_estimators'])
#         mlflow.log_param("max_depth",grid_serach.best_params_['max_depth'])
#         mlflow.log_param("min_samples_split",grid_serach.best_params_['min_samples_split'])
#         mlflow.log_param("min_samples_leaf",grid_serach.best_params_['min_samples_leaf'])
...
#         if tracking_url_type_store != 'file':
#             mlflow.slearn.log_model(best_model,"model",registered_model_name="Best Model")
#         else:
#             mlflow.sklearn.log_model(best_model, "model", signature=signature)
